...
pub use meta::{
    ...
    FulltextEntity, FulltextIndexEntry, IndexState, Meta, PendingSchema, RelCompositeIndexEntry,
    SpatialEntity, SpatialIndexEntry, Statistics, StoreMeta, TextIndexEntry, VectorEntity,
...
pub use store::{
    DEFAULT_CHECKPOINT_INTERVAL_BYTES, DeadIndexKey, DirectionalRelCounts, GcPassReport,
    IndexInterest, META_PAGE, MvccStampField, RecordStore, STORE_COUNT, StoreKind,
};
